...
if ($type == 'join' || $command == '/menu') {
    $text = "Hallo semuanya... terimakasih sudah mengundang Kura kegrup ini, silakan ketik 'keyword' tanpa tanda petik untuk mengetahui isi keyword dari kura silakan mencoba...";
    $balas = array(
